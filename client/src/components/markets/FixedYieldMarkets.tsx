...
const FixedYieldMarkets: React.FC = () => {
          ...
          <div className="mt-4 md:mt-0">
            <div className="bg-[#151f35] p-3 rounded-lg inline-block">
              <div className="flex items-center">
                <span className="text-sm text-gray-300 mr-3">Average Fixed APY:</span>
                <span className="text-lg font-semibold text-white">10.15%</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#0a1529] rounded-xl border border-[#1a2b46] overflow-hidden">
        <div className="px-6 py-4 border-b border-[#1a2b46]">
          <div className="flex justify-between items-center">
            <h2 className="text-xl text-white font-semibold">Available Fixed Yields</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="text-left text-gray-400 text-sm border-b border-[#1a2b46]">
                ...
                <th className="px-6 py-4 font-medium text-white">Fixed APY</th>
...
export default FixedYieldMarkets;